...
export const gradeDefault = () => ({density:0,depth:0,protect:0.7,exposure:0,contrast:1,saturation:1,temperature:0,tint:0,shadows:0,highlights:0,fade:0,red:0,yellow:0,green:0,cyan:0,blue:0,magenta:0});
export const newProject = () => ({version:1,name:'Untitled',fps:30,ratio:'16:9',clips:[],audio:[],texts:[],assets:[]});
